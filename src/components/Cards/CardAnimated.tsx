...
} from '@/components/Cards/morphing-dialog';
  ...
  return (
    ...
    >
      <MorphingDialogTrigger
        ...
        className='flex flex-col w-full overflow-hidden border border-zinc-950/10 bg-white dark:border-zinc-50/10 dark:bg-zinc-900'
      >
        <MorphingDialogImage
          src='/vercel.svg'
